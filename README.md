...
| **실용성** | 20% | URL 클릭 즉시 사용 · 영-한 용어집으로 팀 도입 가능 · 실제 인쇄 + 출근 활용 · 16주 진짜 운영 |
| **AI 활용도** | 20% | Claude Opus 4.7 직접 호출 · 단계 강제 태그 · 동적 JSON 처방전 · Mermaid 즉석 · 큐레이션+LLM 하이브리드 |
| **와우 포인트** | 10% | WOW#1 종이 처방전 / WOW#2 16주 완주 / WOW#3 실시간 멀티유저 / WOW#4 0초 큐레이션 |
...
- 16주 큐레이션 외 새 논문도 Opus 4.7로 즉석 분석
...
**After (16주 후)**: 새 모델 발표 = 기본 논문 계보 위에서 맥락을 읽음 · benchmark = 무엇을 측정·놓치는지 본다 · "이건 ReAct 계열, 이건 memory 문제"

손에 남는 자산: 13편 논문 카드 · 16개 지정 보강 자료 연결 노트 · 16개 팀 산출물 · 팀 공통 AI 언어

> "16주 뒤, AI 변화에 휘둘리지 않는 **기본기**가 생깁니다."
