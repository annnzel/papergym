...
매일 60분 · 26주 · 종이 처방전 + 진짜 시험 + 실시간 동료 리더보드.
...
| **실용성** | 20% | URL 클릭 즉시 사용 · 영-한 용어집으로 팀 도입 가능 · 실제 인쇄 + 출근 활용 · 26주 진짜 운영 |
| **AI 활용도** | 20% | Claude Opus 4.7 직접 호출 · 단계 강제 태그 · 동적 JSON 처방전 · Mermaid 즉석 · 큐레이션+LLM 하이브리드 |
| **와우 포인트** | 10% | WOW#1 종이 처방전 / WOW#2 26주 완주 / WOW#3 실시간 멀티유저 / WOW#4 0초 큐레이션 |
...
- 26주 큐레이션 외 새 논문도 Opus 4.7로 즉석 분석
...
**After (24주 후)**: 새 모델 발표 = 먼저 분류 (reasoning/tool/post-training) · benchmark = 무엇을 측정·놓치는지 본다 · "이건 ReAct 계열, 이건 memory 문제"

손에 남는 자산: 12~18편 논문 카드 · 80~150개 용어집 · 80~120 학습 로그 · 30~50개 업무 적용 프레임

> "24주 뒤, 뉴스가 아니라 **지도가** 보입니다."
